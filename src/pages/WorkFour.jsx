  ...
  return (
    <>
      <div className="lg:mt-[10vh] md:mt-[6vh] mt-[8vh] py-14 min-h-screen w-full bg-[#3E2519] flex flex-col gap-4 items-center">
        <div className="flex justify-between md:flex-row flex-col items-center h-[70vh] md:h-[30vh] lg:h-[70vh] w-[90vw]">
          <div className="h-full  w-full rounded-2xl text-center md:hidden flex flex-col justify-center items-center gap-2  text-[#FEF1D9] ">
            ...
            <div className=" text-[3vw] pb-6 font-[300] ">
              A contemporary café interior designed to create a warm and
              welcoming environment while maintaining a clean, modern aesthetic.
              The layout was carefully planned to ensure smooth movement,
              comfortable seating, and a balanced connection between lighting,
              materials, and spatial flow. The design focuses on enhancing the
              customer experience while reflecting a relaxed yet refined café
              atmosphere.
            </div>
          </div>
        ...
        <div className=" bg-[url(/images/workFour/fourFour.webp)] bg-bottom h-[40vh] lg:h-[100vh] md:-[70vh] bg-cover rounded-2xl w-[90vw]"></div>
      </div>
