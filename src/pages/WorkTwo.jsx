  ...
  return (
    <>
      <div className="lg:mt-[10vh] md:mt-[6vh] mt-[8vh] py-14 min-h-screen w-full bg-[#3E2519] flex flex-col gap-4 items-center">
        <div className="flex justify-between md:flex-row flex-col items-center h-[70vh] md:h-[30vh] lg:h-[70vh] w-[90vw]">
          <div className="h-full  w-full rounded-2xl text-center md:hidden flex flex-col justify-center items-center gap-2  text-[#FEF1D9] ">
            ...
            <div className=" text-[3vw] pb-6 font-[300] ">
              A high-end residential interior concept developed around a dark,
              sophisticated color palette to convey depth, elegance, and modern
              luxury. The design emphasizes contrast, layered textures, and
              controlled lighting to create a strong visual identity while
              maintaining comfort and functionality throughout the living
              spaces.
            </div>
          </div>
        ...
        <div className=" bg-[url(/images/workTwo/twoSix.webp)] bg-center rounded-2xl bg-cover h-[40vh] md:h-[70vh] w-[90vw]"></div>
        ...
        <div className=" bg-[url(/images/workTwo/twoFour.webp)] h-[40vh] md:h-[70vh] bg-cover bg-center rounded-2xl w-[90vw]"></div>
      </div>
