    ...
    <div className='lg:mt-[10vh] md:mt-[6vh] mt-[8vh] py-14 min-h-screen w-full bg-[#3E2519] flex flex-col gap-4 items-center'>
        <div className='flex justify-between md:flex-row flex-col items-center h-[70vh] md:h-[30vh] lg:h-[70vh] w-[90vw]'>
            <div className='h-full  w-full rounded-2xl text-center md:hidden flex flex-col justify-center items-center gap-2  text-[#FEF1D9] '>
                <div className='uppercase text-[12vw] leading-none'>Luma <br /> residence</div>
            ...
            <div className='h-full  w-[49%] rounded-2xl hidden md:flex flex-col justify-center items-start gap-2 pr-10 text-[#FEF1D9] '>
                ...
                <div  className=' text-[1vw] font-[300] '>A bright and minimal residential interior designed to highlight openness, natural light, and visual balance. Neutral tones, clean lines, and thoughtful proportions were used to create a calm and timeless living environment. The design prioritizes simplicity and comfort while enhancing the sense of space and clarity.</div>
            </div>
        </div>
              <div className=' bg-[url(/images/workOne/oneFive.webp)] bg-center rounded-2xl bg-cover h-[40vh] md:h-[70vh] w-[90vw]'>
