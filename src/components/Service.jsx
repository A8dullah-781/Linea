...
const Service = ({ scrollToContact }) => {
  ...
  const visibleServices = showAll ? serviceInfo : serviceInfo.slice(0, 2);
  ...
  return (
    <div
      id="services-section"
      className="h-full px-[5vw] pb-10 w-screen bg-[#3E2519] md:bg-[#FEF1D9]"
    >
      <div
        ref={titleRef}
      ...
      <div className="rounded-2xl hidden md:block relative overflow-hidden w-full">
        ...
        >
          <div>
            ...
            <p className="text-[1.5vw]">
              Clear and realistic 3D concepts that help clients visualize the
              final interior before execution begins.
            </p>
          </div>
          <Link to="/services">
            <div className="flex flex-row gap-3 hover:scale-105 transition-all duration-150 justify-center items-center">
              ...
              className={`
               ...
               ${
                 hidden
                   ...
                   : "max-h-[100vh] opacity-100 scale-100"
               }
             `}
            >
