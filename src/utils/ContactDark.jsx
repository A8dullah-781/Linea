...
const ContactDark = forwardRef((props, ref) => {
  return (
    <div
      ref={ref}
      id="contact"
      className="flex px-[5vw] bg-[#FEF1D9] FEF1D9 md:bg-[#3E2519] items-center flex-col md:flex-row "
    >
      <div className="py-[4vh] md:py-[8vh] md:text-[#FEF1D9] text-[#3E2519] gap-4 flex flex-col justify-evenly items-start w-full md:w-[55%]">
      ...
      <div className="h-full flex justify-center items-center w-full md:w-[45%] ">
        <div className="bg-[#3E2519] border-1 border-[#FEF1D9] text-[#FEF1D9] rounded-3xl lg:my-10 mb-6 md:mb-0 h-[70%] w-[90%]">
          <form
          ...
          >
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                name="email"
                required
                className=" px-3 text-[#3E2519] bg-[#FEF1D9] py-2 rounded-3xl"
              />
            </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <textarea
                ...
                rows="3"
                required
                className="px-3 text-[#3E2519] bg-[#FEF1D9] py-2 rounded-3xl resize-none"
              />
            </div>

            <button
              type="submit"
              className="mt-2 text-xs text-[#3E2519] bg-[#FEF1D9] w-[45%] py-3 rounded-2xl hover:bg-[#f7d391]"
            >
